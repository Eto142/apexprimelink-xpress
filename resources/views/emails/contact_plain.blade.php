...
<head>
    ...
    <style>
        ...
        .header { background-color: #1B4332; color: #ffffff; padding: 20px; text-align: center; }
        .header img { max-width: 150px; margin-bottom: 10px; }
        .header h1 { margin: 0; font-size: 22px; }
        .body { padding: 20px; }
        .body h2 { color: #1B4332; font-size: 18px; margin-bottom: 15px; }
        .body p { margin-bottom: 10px; line-height: 1.6; }
        .message-box { background-color: #f9f9f9; padding: 15px; border-left: 4px solid #1B4332; margin: 15px 0; }
